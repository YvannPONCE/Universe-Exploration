package uniexp.galaxy.graph;

import uniexp.galaxy.graph.exception.BadVertexException;
import uniexp.galaxy.graph.exception.DuplicateTagException;
...
public abstract class AbstractGraph implements Graph {
    ...
    private class EdgeIterator implements Iterable<Edge>, Iterator<Edge> {
        ...
        public boolean hasNext() {
            return secondMapIterator != null && (secondMapIterator.hasNext() || firstMapIterator.hasNext());
        }
